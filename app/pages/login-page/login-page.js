...
class LoginPage extends intl(cellsPage(LitElement)) {
  static get is() {
    return 'login-page';
  }
  ...
  render() {
    return html`
      <demo-web-template page-title="Login">
        <div slot="app-top-content">${this._headerTpl}</div>

        <div slot="app-main-content">
          ${this._formLoginTpl}
          ${this._opportunityTpl(
            this.t(this._i18nKeys.outstandingHeader1),
            this.t(this._i18nKeys.outstandingTitle1),
            expenses
          )}
          ${this._opportunityTpl(
            this.t(this._i18nKeys.outstandingHeader2),
            this.t(this._i18nKeys.outstandingTitle2),
            moneygraphic
          )}
        </div>
      ...
      <bbva-core-collapse id="${this._uniqueId}" ?opened="${this.showForm}">
        <form enctype="multipart/form-data">
          <bbva-web-form-fieldset
            legend="${this.t(this._i18nKeys.legendRadio)}"
            sr-only
          >
            <bbva-web-form-radio-button name="client" value="yes" checked
              >${this.t(this._i18nKeys.labelRadio1)}</bbva-web-form-radio-button
            >
            <bbva-web-form-radio-button name="client" value="no"
              >${this.t(this._i18nKeys.labelRadio2)}</bbva-web-form-radio-button
            >
          </bbva-web-form-fieldset>
          ...
          <bbva-web-form-text
            id="company"
            label="${this.t(this._i18nKeys.labelInput1)}"
          ></bbva-web-form-text>
          <bbva-web-form-text
            id="user"
            label="${this.t(this._i18nKeys.labelInput2)}"
          ></bbva-web-form-text>
          <bbva-web-form-text
            id="password"
            label="${this.t(this._i18nKeys.labelInput3)}"
          ></bbva-web-form-text>
  ...
  get _footerTpl() {
    return html`
      ...
      >
        ...
        >
        <bbva-web-module-footer-language-list-item slot="languages"
          >Catalá</bbva-web-module-footer-language-list-item
        >
        <bbva-web-module-footer-language-list-item
          slot="languages"
        ...
        >
        <bbva-web-module-footer-language-list-item slot="languages"
          >Gallego</bbva-web-module-footer-language-list-item
        >
        <bbva-web-module-footer-language-list-item slot="languages"
          >Euskera</bbva-web-module-footer-language-list-item
        >
        ...
        <bbva-web-link-list-item variant="subdued" slot="navigation"
          >${this.t(this._i18nKeys.footerNavigation1)}</bbva-web-link-list-item
        >
        <bbva-web-link-list-item variant="subdued" slot="navigation"
          >${this.t(this._i18nKeys.footerNavigation2)}</bbva-web-link-list-item
        >
        <bbva-web-link-list-item variant="subdued" slot="navigation"
          >${this.t(this._i18nKeys.footerNavigation3)}</bbva-web-link-list-item
        >
        <bbva-web-link-list-item variant="subdued" slot="navigation"
          >${this.t(this._i18nKeys.footerNavigation4)}</bbva-web-link-list-item
        >
        <bbva-web-link-list-item variant="subdued" slot="navigation"
          >${this.t(this._i18nKeys.footerNavigation5)}</bbva-web-link-list-item
        >
        <bbva-web-link-list-item variant="subdued" slot="navigation"
          >${this.t(this._i18nKeys.footerNavigation6)}</bbva-web-link-list-item
        >
        <bbva-web-link-list-item variant="subdued" slot="navigation"
          >${this.t(this._i18nKeys.footerNavigation7)}</bbva-web-link-list-item
        >
        <bbva-web-link-list-item variant="subdued" slot="navigation"
          >${this.t(this._i18nKeys.footerNavigation8)}</bbva-web-link-list-item
        >
      </bbva-web-module-footer>
    `;
  }
