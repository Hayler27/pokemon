...
class HelpAPage extends intl(cellsPage(LitElement)) {
  static get is() {
    return 'help-page';
  }
        ...
        <div slot="app-main-content">
          ...
          <div role="list">
            <bbva-web-list-item-bullet
              >${this.t(this._i18nKeys.firstList)}</bbva-web-list-item-bullet
            >
            <bbva-web-list-item-bullet
              >${this.t(this._i18nKeys.secondList)}</bbva-web-list-item-bullet
            >
            <bbva-web-list-item-bullet
              >${this.t(this._i18nKeys.thirdList)}</bbva-web-list-item-bullet
            >
            <bbva-web-list-item-bullet
              >${this.t(this._i18nKeys.fourthList)}</bbva-web-list-item-bullet
            >
            <bbva-web-list-item-bullet
              >${this.t(this._i18nKeys.fifthList)}</bbva-web-list-item-bullet
            >
          </div>
        </div>
      </demo-web-template>
